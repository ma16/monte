...
bool Signaling::init()
{
    ...
    // [todo] if the ARM Counter is not set up properly, this will
    // freeze the whole CPU with all it cores.
#endif    
    this->master->io.detect(this->master->pin,Rpi::Gpio::Event::AsyncFall) ;
